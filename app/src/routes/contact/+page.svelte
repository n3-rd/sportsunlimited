<script lang="ts">
  ...
  import * as Card from "$lib/components/ui/card";
	...
	const seoData = {
		title: 'Contact Us | Sports Unlimited - Get in Touch',
		description: 'Contact Sports Unlimited for sports news inquiries, feedback, or collaboration. Reach out via email or WhatsApp for Nigerian sports coverage questions.',
		keywords: 'contact sports unlimited, sports news contact, Nigerian sports inquiries, sports collaboration',
	};
